...
class Lipscore_Admin_Settings_Tab {
    ...
    protected function locale_setting() {
        return array(
            ...
            'options'   => array(
                'cs'    => __( 'Czech', 'woocommerce-settings-tab-lipscore' ),
                'da'    => __( 'Danish', 'woocommerce-settings-tab-lipscore' ),
                ...
                'ko'    => __( 'Korean', 'woocommerce-settings-tab-lipscore' ),
                ...
                'pt-BR' => __( 'Portuguese (Brazil)', 'woocommerce-settings-tab-lipscore' ),
                'pt-PT' => __( 'Portuguese (Portugal)', 'woocommerce-settings-tab-lipscore' ),
                ...
                'sv'    => __( 'Swedish', 'woocommerce-settings-tab-lipscore' ),
            )
        );
    }
